...
# The above are now done together in the below command which installs az cli
...
wget https://downloads.mongodb.com/compass/mongodb-compass_1.40.4_amd64.deb -O ~/Downloads/mongocompass.deb
